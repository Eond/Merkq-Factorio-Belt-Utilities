...
if mods["Krastorio2"] then
    ...
    local my_adv_main = data.raw["simple-entity-with-owner"][generate_name("lane-swapper-kr-advanced-main")]
    local my_adv_real = data.raw["linked-belt"][generate_name("lane-swapper-kr-advanced-real")]
    ...
    local my_sup_main = data.raw["simple-entity-with-owner"][generate_name("lane-swapper-kr-superior-main")]
    local my_sup_real = data.raw["linked-belt"][generate_name("lane-swapper-kr-superior-real")]
