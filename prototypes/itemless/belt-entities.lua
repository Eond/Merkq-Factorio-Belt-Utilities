...
-- they are just entites. Hence itemless
...
data:extend({
    ...
    {
        type               = "linked-belt",
        name               = generate_name("itemless-linked-fast-belt"),
        allow_side_loading = true,
        speed              = base_speed * 2,
        max_health         = 160,
        flags              = itemless_flags,
    ...
    {
        type               = "linked-belt",
        name               = generate_name("itemless-linked-express-belt"),
        allow_side_loading = true,
        speed              = base_speed * 3,
        max_health         = 170,
        flags              = itemless_flags,
    ...
    {
        type               = "linked-belt",
        name               = generate_name("itemless-under-ultra-belt"),
        allow_side_loading = true,
        speed              = ultra_speed,
        max_health         = 1000,
        flags              = itemless_flags,
